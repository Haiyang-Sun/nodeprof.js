...
public class PromiseFactory extends AbstractFactory {

    public PromiseFactory(Object jalangiAnalysis, DynamicObject pre,
                    DynamicObject post) {
        super("promise", jalangiAnalysis, pre, post, 4, 6);
    }
    ...
    public BaseEventHandlerNode create(EventContext context) {
        return new BuiltinRootEventHandler(context) {
            ...
            final boolean isTarget = getBuiltinName().contains("Promise");
            ...
            public void executeExceptional(VirtualFrame frame, Throwable exception) {
                if (isTarget && post != null) {
                    ...
                    setPostArguments(5, exceptionValue);
                    directCall(postCall, false, getSourceIID());
                }
            }
        };

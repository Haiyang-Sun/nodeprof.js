...
public class TrivialAnalysis extends NodeProfAnalysis {
...
// String tagsStr = System.getenv("NODEPROF_BENCH_TAG");
        final boolean saveInput = true;// "true".equals(System.getenv("NODEPROF_SAVE_INPUT"));
        final boolean saveInputLocal = "true".equals(System.getenv("NODEPROF_LOCAL_INPUT"));
        final boolean useInput = true;// saveInput &&
                                      // "true".equals(System.getenv("NODEPROF_USE_INPUT"));

        for (final ProfiledTagEnum tag : ProfiledTagEnum.values()) {

            try {
                Logger.info("Tag enabled: " + tag);
